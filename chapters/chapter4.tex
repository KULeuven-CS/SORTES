...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{microCOS_states.png}
...
The \defineabrv{Fault Tolerant Average}{FTA} Algorithm is designed to synchronize clocks in a distributed system. There are two variants. The first ignores communication delays between systems, the second don't.
\\\\
