...
\]
We define the \index{MTBF | see {Mean Time Between Failures} } \definebf{Mean Time Between Failures} (MTBF) as:
\[
...
Other useful metrics are the \definebf{availability} $A(t)$ and the \index{MTTR | see {Mean Time To Repair}} \definebf{Mean Time To Repair} (MTTR):
\[
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{active_basic.jpg}
