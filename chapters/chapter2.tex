...
\end{enumerate}
Because of these questions the created model should be shown to the author of the specifications: He \textbf{must} understand and agree with the model.
...
\begin{itemize}
	\item Model the tructure of the physical system. 
