...
\includelisting{ASGExample.c}{style=cstyle, caption=Example of cooperative multitasking where task A is run twice as frequent as task B., label=ex:coopmulti}
